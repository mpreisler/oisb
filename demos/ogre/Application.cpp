...
void Application::initializeCEGUI()
{
    ...
    mUIRoot = static_cast<CEGUI::DefaultWindow*>(CEGUI::WindowManager::getSingleton().createWindow("DefaultWindow", "Root"));
    ...
    mUIRoot->addChild(CEGUI::WindowManager::getSingleton().loadWindowLayout("HUD.layout"));
